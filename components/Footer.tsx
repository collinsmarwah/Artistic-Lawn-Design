...
const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-white dark:bg-background-dark border-t border-border-light dark:border-border-dark mt-auto flex flex-col">
      {/* Prominent CTA Section */}
      <div className="w-full bg-[#0d1b12] py-12 px-4 md:px-10 border-b border-border-light dark:border-border-dark relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[1280px] mx-auto flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
          <div className="flex flex-col gap-3 max-w-2xl">
            <h2 className="text-3xl md:text-4xl font-black text-white leading-tight tracking-tight">Ready to Transform Your Outdoors?</h2>
            <p className="text-gray-300 text-lg font-medium">
              Contact Artistic Lawn Design today for a free consultation. Let's make your lawn the envy of the neighborhood.
            </p>
          </div>
          <Link to="/contact" className="group shrink-0 flex items-center justify-center gap-2 rounded-lg bg-primary px-8 py-4 text-[#0d1b12] text-lg font-bold transition-all hover:bg-primary-hover hover:scale-105 shadow-lg shadow-green-900/20">
      ...
      {/* Main Footer Links */}
      <div className="pt-16 pb-8 px-4 md:px-10">
